...
import {addMoneyToBudget, createMessage, repairHouse, toFareStaff, toHireStaff} from "./03";
...
test("Budget should de changes fo HOSPITAL", () => {
...
test("staff should be increased", () => {
    toFareStaff(city.governmentBuildings[0], 20)
...
test("Grating message should be correct for city", () => {
